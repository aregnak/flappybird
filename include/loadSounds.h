...
// game texts
inline sf::Text createGameOverText(sf::Font& _font, const sf::RenderWindow& _window)
{
    ...
    gameOverText.setPosition(
        { _window.getSize().x / 2.f - gameOverText.getLocalBounds().size.x / 2,
          _window.getSize().y / 2.f - gameOverText.getLocalBounds().size.y / 2 });
    gameOverText.setOutlineColor(sf::Color::Black);
    gameOverText.setOutlineThickness(5.f);
    return gameOverText;
}

inline sf::Text createMainMenuText(sf::Font& _font, const sf::RenderWindow& _window)
{
    ...
    mainMenuText.setPosition(
        { _window.getSize().x / 2.f - mainMenuText.getLocalBounds().size.x / 2,
          _window.getSize().y / 2.f - mainMenuText.getLocalBounds().size.y / 2 });
    mainMenuText.setOutlineColor(sf::Color::Black);
    mainMenuText.setOutlineThickness(5.f);
    return mainMenuText;
}

inline sf::Text createPausedText(sf::Font& _font, const sf::RenderWindow& _window)
{
    sf::Text pausedText(_font, "Game Paused\nPress Escape or P");
    pausedText.setCharacterSize(40);
    pausedText.setFillColor(sf::Color::White);
    pausedText.setStyle(sf::Text::Bold);
    pausedText.setPosition({ _window.getSize().x / 2.f - pausedText.getLocalBounds().size.x / 2,
                             _window.getSize().y / 2.f - pausedText.getLocalBounds().size.y / 2 });
    pausedText.setOutlineColor(sf::Color::Black);
    pausedText.setOutlineThickness(5.f);
    return pausedText;
}

inline sf::Text createScoreText(sf::Font& _font, const sf::RenderWindow& _window)
{
...
inline sf::Text createHighscoreText(sf::Font& _font, const sf::RenderWindow& _window)
{
